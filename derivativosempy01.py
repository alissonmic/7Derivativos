...
df = optionchain(subjacente)

#Especifique o caminho e o nome do arquivo Excel de destino
caminho_arquivo_excel = 'exemplo.xlsx'

#Exporte o DataFrame para o arquivo Excel
df.to_excel(caminho_arquivo_excel, index=False)  # index=False para não incluir o índice do DataFrame no arquivo Excel